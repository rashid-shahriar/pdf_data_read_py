...
# Open the PDF files
pdf_one = fitz.open("low_balance_report_Jan_15.pdf")
pdf_two = fitz.open("low_balance_report_Jan_16.pdf")
...
dfs_one = tabula.read_pdf("low_balance_report_Jan_14.pdf", pages='all', lattice=True)
dfs_two = tabula.read_pdf("low_balance_report_Jan_15.pdf", pages='all', lattice=True)
